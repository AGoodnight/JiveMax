...
slides_triggers.push( new Scene({wrapper:'#slide-2-triggers', paused:true}).jig('h4','hop',{strength:3,speed:0.8},{repeat:30}) );
...
var slides_hotspots= [];
slides_hotspots.push( new Scene({wrapper:'#slide-1-hotspots', paused:true}).jig('h4','wiggle',{speed:0.4},{repeat:30}) );
slides_hotspots.push( new Scene({wrapper:'#slide-2-hotspots', paused:true}).yoyo('h4',1,{rotationY:180,ease:'Elastic.easeOut'},{repeat:30}) );
